...
// Показываем диалог с помощью метода show(он принимает фрагмент менеджер и тэг)
// а слушаем с помощью мэнеджера,овнера и лисенера,лисенер берёт отправленный результат и по ключу открывает
// посланный снаружи лесенер запускается с помощью invoke и производит действие с результатом